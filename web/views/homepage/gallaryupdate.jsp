...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String[] nameArr = (String[])request.getAttribute("gfile");
    %>
<!DOCTYPE html>
<html lang="ko">
<head>
  ...
  <!-- 메인 컨텐츠 구역 -->
  	<div class="container" >
    	<div class="row">
            ...
            <br><br>
            <form action="<%= request.getContextPath() %>/updategboard" method="post" enctype="multipart/form-data">
              <table class="table table-bordered" style="background: white;">
                  <tbody>
                          <tr>
                              <th>제목: </th>
                              <td colspan="2"><input type="text" placeholder="제목을 입력하세요. " name="gtitle" class="form-control" value="<%= g.getGtitle() %>" readonly="readonly"/></td>
                          </tr>
                          <tr>
                              <th>내용: </th>
                              <td colspan="2">
                              <textarea cols="10" placeholder="내용을 입력하세요. " id="bcontent" name="gcontent" class="form-control" style="height: 500px; resize: none;" ><%= g.getGcontent() %></textarea>
                              </td>
                          </tr>
                          <tr>
                              <th>현재파일: </th>
