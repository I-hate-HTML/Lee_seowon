			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown show"><a class="nav-link dropdown-toggle" href="gallaryBoard.html" id="dropdown01">앨범</a></li>
						<li class="nav-item dropdown show"><a class="nav-link dropdown-toggle" href="board.html" id="dropdown01">커뮤니티</a></li>
